...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> manejarCategoriaNoEncontrada(CategoriaNotFoundException ex, HttpServletRequest request) {
        logger.warn("Recurso no encontrado - Categoria ID: {} | Path: {}", ex.getCategoriaId(), request.getRequestURI());
